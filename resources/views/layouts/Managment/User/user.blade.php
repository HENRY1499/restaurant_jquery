        ...
        <div class="w-full rounded-xl shadow-sm shadow-green-400 px-3 mt-2">
            <div class="p-2">
                <div class="flex flex-row justify-between items-center place-items-center">
                    <h1 class="text-black font-bold leading-none">Usuarios</h1>
                    <a href="{{route('user.create')}}" class="hover:-translate-y-2 duration-500 px-4 py-2 rounded-md border-none bg-gradient-to-l from-green-400 to-green-600">
                ...
                <table class="w-full border table-fixed">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4">
                                <span class="inline-flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-medium text-green-700 ring-1 ring-inset ring-green-600/20">{{$u->status}}</span></td>
                            <td class="py-2 px-4">
                                <div class="flex flex-row gap-4">
                                    <a href="{{route('user.edit',$u->id)}}" class="bg-blue-500 text-white py-2 px-4 rounded-md">Editar</a>
                                    <form method="post" action="{{route('user.destroy',$u->id)}}" class="bg-red-500 text-white py-2 px-4 rounded-md">
                                        @csrf
                                        @method('DELETE')
