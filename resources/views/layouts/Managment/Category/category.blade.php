        ...
        <div class="w-full rounded-xl shadow-sm shadow-green-400 px-3 mt-2">
            <div class="p-2">
                <div class="flex flex-row justify-between items-center place-items-center">
                    <h1 class="text-black font-bold leading-none uppercase">Categoria</h1>
                    <a href="category/create" class="hover:-translate-y-2 duration-500 px-4 py-2 rounded-md border-none bg-gradient-to-l from-green-400 to-green-600">
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4">
                                <div class="flex flex-row gap-4">
                                    <a href="{{route('category.edit',$c->id)}}" class="bg-blue-500 text-white py-2 px-4 rounded-md">Editar</a>
                                    <form method="post" action="{{route('category.destroy',$c->id)}}" class="bg-red-500 text-white py-2 px-4 rounded-md">
                                        @csrf
                                        @method('DELETE')
